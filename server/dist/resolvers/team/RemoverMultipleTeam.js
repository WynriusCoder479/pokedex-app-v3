...
exports.UserRemoverMultipleTeamResolver = void 0;
...
let UserRemoverMultipleTeamResolver = class UserRemoverMultipleTeamResolver {
    async removeMultipleTeam(id, context) {
        try {
            const { req } = context;
...
], UserRemoverMultipleTeamResolver.prototype, "removeMultipleTeam", null);
UserRemoverMultipleTeamResolver = __decorate([
    (0, type_graphql_1.Resolver)()
], UserRemoverMultipleTeamResolver);
exports.UserRemoverMultipleTeamResolver = UserRemoverMultipleTeamResolver;
//# sourceMappingURL=RemoverMultipleTeam.js.map