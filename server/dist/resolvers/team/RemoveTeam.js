...
exports.UserRemoveTeamResolver = void 0;
...
let UserRemoveTeamResolver = class UserRemoveTeamResolver {
    async removeTeam(id, context) {
        try {
            const { req } = context;
...
], UserRemoveTeamResolver.prototype, "removeTeam", null);
UserRemoveTeamResolver = __decorate([
    (0, type_graphql_1.Resolver)()
], UserRemoveTeamResolver);
exports.UserRemoveTeamResolver = UserRemoveTeamResolver;
